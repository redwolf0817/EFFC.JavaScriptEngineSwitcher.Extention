...
using OriginalJsException = EFFC.ChakraCore.JsRt.JsException;

using JavaScriptEngineSwitcher.Core;
using JavaScriptEngineSwitcher.Core.Utilities;
using CoreStrings = JavaScriptEngineSwitcher.Core.Resources.Strings;

using EFFC.ChakraCore.Helpers;
using EFFC.ChakraCore.JsRt;
using EFFC.ChakraCore.Resources;
...
{
    public class EFFCChakraCoreJsEngine : JsEngineBase
    {
        /// <summary>
		/// Name of JS engine
		/// </summary>
		public const string EngineName = "EFFCChakra";
        ...
        /// Script dispatcher
        /// </summary>
        private readonly EFFCScriptDispatcher _dispatcher = new EFFCScriptDispatcher();

        /// <summary>
        /// Unique document name manager
        /// </summary>
        protected readonly UniqueDocumentNameManager _documentNameManager =
        ...
        public JsContext CurrnetJsContext { get => _jsContext; set => _jsContext = value; }

        /// <summary>
        /// Constructs a instance of adapter for the ChakraCore JS engine
        /// </summary>
        public EFFCChakraCoreJsEngine()
        ...
        /// Modified by chuan.yin in 2017/4/27
		/// </summary>
		/// <param name="value">The source value</param>
		/// <returns>The mapped value</returns>
        ...
        protected override object InnerGetVariableValue(string variableName)
        {
            object result = InvokeScript(() =>
            {
                ...
                //modified by chuan.yin 
                //return MapToHostType(variableValue);
                return ConvertJsObjectToNetObject(variableValue);
            });
